...
- **Estandarizaci�n de Textos:** Se implement� la inserci�n autom�tica de los textos prefijados para la 'Descripci�n Completa' y 'Competencias del Curso' en las vistas de presentaci�n (pantalla del curso, tarjetas y expediente) y en el PDF/Vista de las microcredenciales, garantizando uniformidad en todos los cursos sin que los instructores deban teclearlo manualmente.
- **Control de Duraci�n:** Se modific� el campo de duraci�n en la creaci�n/edici�n de cursos para aceptar �nicamente n�meros y autocompletar la palabra 'Horas'. Se agreg� la funci�n 'formatDuracion' en utils para garantizar que en los certificados, curso p�blico, panel de administrador y expediente del alumno se visualice uniformemente 'X Hora(s)' previniendo repeticiones como '10 horas Horas'.

### ?? Migraci�n de Landing Page Institucional a CursosIEDCH (18 de Agosto de 2026)
- **Integraci�n de Dise�o:** Se migr� el dise�o principal del sitio institucional grupoegac.com (originalmente en IEDCH2) directamente a la p�gina principal de CursosIEDCH (pp/page.tsx).
...
- **Modal de Registro/Login:** Se implement� un modal interactivo (CourseModal) accionado por el bot�n 'Quiero publicar un curso' que ofrece opciones a Instructores e Instituciones para redirigir al login actual.
- **Cursos Din�micos:** La secci�n 'Cursos populares' fue conectada a la base de datos de Supabase para obtener en tiempo real los �ltimos 4 cursos publicados y mostrar su informaci�n (imagen, t�tulo, precio).
- **Pruebas E2E:** Se cre� el archivo de pruebas e2e/landing.spec.ts para verificar la carga correcta del nuevo layout y la funcionalidad del modal.
