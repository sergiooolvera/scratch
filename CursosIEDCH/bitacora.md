...
### ?? Restricci�n de Ex�menes a Opci�n M�ltiple
- **Uso exclusivo de Opci�n M�ltiple:** Se elimin� la posibilidad de agregar preguntas de 'Respuesta Libre' en los m�dulos de creaci�n y edici�n de cursos (subir-curso y editar-curso).
- **Validaci�n en Extracci�n PDF:** Se actualiz� la ruta de extracci�n de ex�menes (parse-exam) para rechazar PDFs que contengan indicaciones de respuesta libre, retornando un error claro al profesor.
- **Actualizaci�n de Plantilla:** Se modific� la plantilla de ejemplo (ejemplo-examen.html), retirando los ejemplos de preguntas abiertas y a�adiendo una nota expl�cita sobre el uso obligatorio y exclusivo de preguntas de opci�n m�ltiple.

---
*�ltima actualizaci�n: 9 de Junio de 2026*
