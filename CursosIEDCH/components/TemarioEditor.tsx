                                ...
                                <div className="flex items-center justify-between px-4 py-3 bg-gray-50/70 border-b border-gray-100 gap-3">
                                    <div className="flex items-center gap-2 flex-1 min-w-0">
                                        ...
                                        <input
                                            ...
                                            className="w-full text-sm text-gray-800 bg-orange-50 border border-orange-200 hover:border-orange-300 focus:border-orange-500 focus:bg-white focus:ring-2 focus:ring-orange-500/20 rounded-lg px-2.5 py-1.5 transition font-medium placeholder:font-normal placeholder-gray-400 outline-none"
                                        />
                                    </div>
                                            ...
                                            {(mod.temas || []).map((tema, temaIdx) => (
                                                <div key={temaIdx} className="flex items-center gap-2 group">
                                                    ...
                                                    <input
                                                        ...
                                                        className="flex-1 text-sm text-gray-700 bg-orange-50 border border-orange-200 hover:border-orange-300 focus:border-orange-500 focus:bg-white focus:ring-2 focus:ring-orange-500/20 rounded-lg px-2.5 py-1.5 transition placeholder-gray-400 outline-none"
                                                    />
                                                    <button
                                                        type="button"
