                ...
                {items.map((competencia, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={`flex-1 flex items-center bg-orange-50 focus-within:bg-white border rounded-xl px-3.5 py-2.5 shadow-sm transition-all focus-within:ring-2 focus-within:ring-orange-500/20 focus-within:border-orange-500 ${
                                isOverLimit ? 'border-red-300 ring-1 ring-red-200' : 'border-orange-200'
                            }`}>
