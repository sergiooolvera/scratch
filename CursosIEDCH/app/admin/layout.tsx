        ...
        <div className="bg-gray-800 text-white shadow-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-wrap gap-2 md:gap-6 py-4 text-sm font-medium">
                    ...
                    <Link href="/admin/validaciones" className="px-3 py-2 rounded-md bg-blue-900/50 hover:bg-blue-800 transition text-blue-100 border border-blue-800">Validar Identidades</Link>
