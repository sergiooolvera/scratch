                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="titulo" required maxLength={60} value={formData.titulo} onChange={handleChange} className="w-full rounded-xl border-orange-200 shadow-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 border p-3 text-black bg-orange-50 focus:bg-white transition-colors" placeholder="Ej. Fundamentos de la Práctica Médica Moderna" />
                                ...
                                <div>
                                    ...
                                    <textarea name="descripcion" required value={formData.descripcion} onChange={handleChange} rows={4} className="w-full rounded-xl border-orange-200 shadow-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 border p-3 text-black bg-orange-50 focus:bg-white transition-colors" placeholder="Describe los temas que cubre el curso..." />
                                </div>
                                <div>
                                    <TemarioEditor
                                        temario={temario}
