                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="titulo" required maxLength={60} value={formData.titulo} onChange={handleChange} className="w-full rounded-xl border-orange-200 shadow-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 border p-3 text-black bg-orange-50 focus:bg-white transition-colors" placeholder="Ej. Fundamentos modernos de..." />
                                ...
                                <div>
                                    ...
                                    <textarea name="descripcion" required value={formData.descripcion} onChange={handleChange} rows={4} className="w-full rounded-xl border-orange-200 shadow-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 border p-3 text-black bg-orange-50 focus:bg-white transition-colors" />
                                </div>
                                <div>
                                    <TemarioEditor
                                        temario={temario}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-gray-100">
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <input type="number" name="duracion" required min="1" max="999" value={formData.duracion ? String(formData.duracion).replace(/\D/g, '') : ''} onChange={(e) => setFormData({...formData, duracion: e.target.value ? `${e.target.value} ${e.target.value === '1' ? 'Hora' : 'Horas'}` : ''})} className="w-full rounded-xl border-orange-200 shadow-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 border p-3 text-black bg-orange-50 focus:bg-white transition-colors" placeholder="Ej: 10" />
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full rounded-xl border-orange-200 shadow-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 border p-3 text-black bg-orange-50 focus:bg-white transition-colors"
                                        >
...
{/* Modular Puzzle/Game Box */}
                                ...
                                {selectedModuloIdx === 'all' && (
                                    <button
                                        type="button"
                                        onClick={handleAgregarModulo}
                                        className="w-full py-4 border-2 border-dashed border-gray-300 rounded-2xl text-gray-600 font-bold hover:border-blue-400 hover:text-blue-600 transition flex items-center justify-center gap-2 bg-zinc-50 cursor-pointer"
                                    >
                                ...
                                {requiereExamen && (
                                    <div className="mt-6 sm:pl-6 border-l-0 sm:border-l-2 border-green-300 space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                <label className="block text-sm font-semibold text-gray-700 mb-1">Automatización: Cargar examen PDF o pegar texto para leer preguntas</label>
                                                <div className="flex flex-col sm:flex-row gap-3">
                                                    <input
                                                        ...
                                                        disabled={isParsing}
                                                        className="block w-full sm:w-2/3 text-xs text-gray-500 file:mr-2 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-[10px] file:font-semibold file:bg-white file:text-green-700 hover:file:bg-green-100 border border-green-300 rounded-lg bg-white p-1.5 cursor-pointer"
                                                    />
                                                    <button
                                                        type="button"
